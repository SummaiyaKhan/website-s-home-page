  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="bg-[#890620] relative">
        <nav className="w-full py-5 flex justify-between text-[#EBD4CB] cursor-pointer">
      ...
      <div className="relative mt-20">
        <div className="p-4 w-[700px] h-48 bg-[#EBD4CB] rounded-br-[50px] rounded-tl-[50px] flex ml-[550px]">
          ...
          <div className="w-[250px] flex flex-col justify-center ml-4">
            ...
            <p>Recipient of the 2024 International Perfumers Guild Award</p>
          </div>
          ...
          <div className="w-[250px] flex flex-col justify-center ml-4">
            ...
            <p>Featuring <blockquote><q>Elixir of Enchantment</q></blockquote> our top selling fragrance for 3 consecutive years</p>
          </div>
        </div>
      </div>
    </div>
